...
global  FES min_tlbo avg_tlbo  run_time mark_tlbo time_tlbo FES_tlbo;
format long;
global ll ul
if ~exist('note1','var')
    note1 = true;
...
min_tlbo(run_time,1:length(min_result))=min_result;
avg_tlbo(run_time,1:length(avg_result))=avg_result;
time_tlbo(run_time,1:length(TOC))=TOC;
mark_tlbo(run_time,1:length(Mark(1,:)))=Mark(1,:);
FES_tlbo(run_time,1:length(FES1))=FES1;
if run_time==1
    save('TLBO.mat','min_tlbo');
    save('TLBO.mat','avg_tlbo','-append');
    save('TLBO.mat','time_tlbo','-append');
    save('TLBO.mat','mark_tlbo','-append');
    save('TLBO.mat','FES_tlbo','-append');
else
    save('TLBO.mat','min_tlbo','-append');
    save('TLBO.mat','avg_tlbo','-append');
    save('TLBO.mat','time_tlbo','-append');
    save('TLBO.mat','mark_tlbo','-append');
    save('TLBO.mat','FES_tlbo','-append');
